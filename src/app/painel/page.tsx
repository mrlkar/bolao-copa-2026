...
export default function PainelPage() {
  ...
  const pixBolao =
    "00020126550014br.gov.bcb.pix0111271372488020218Bolao da Copa 2026520400005303986540550.005802BR5920MARCIO RIBEIRO LOPES6008OURINHOS62580520SAN2026060514204515950300017br.gov.bcb.brcode01051.0.0630492C9";
  ...
  function renderJogo(jogo: Jogo) {
    ...
    const palpiteJaRegistrado = participante
      ? palpitesPublicos.some(
          (p) =>
            p.jogo_id === jogo.id && p.participante_id === participante.id
        )
      : false;
          ...
          {!participante.pago && (
            <div className="mt-4 bg-red-50 border border-red-300 rounded p-4">
              ...
              <p className="text-red-700">
                Os palpites somente serão liberados após a confirmação do
                pagamento.
              </p>

              <div className="mt-4 flex flex-col items-center">
                <QRCodeSVG value={pixBolao} size={220} />

                <p className="mt-3 font-semibold">PIX: R$ 50,00</p>

                <p className="text-sm text-center">Márcio Ribeiro Lopes</p>

                <p className="text-sm text-center">Chave PIX: 14996020002</p>
          ...
          <div className="mt-6">
            ...
            {mostrarAlterarSenha && (
              <div className="mt-4 bg-slate-50 border rounded p-4">
                ...
                {mensagemSenha && (
                  <p className="mt-3 font-medium">{mensagemSenha}</p>
                )}
              </div>
            )}
          </div>
